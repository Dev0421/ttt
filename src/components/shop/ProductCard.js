...
export default function ProductCard({coins=100, energy=100, text, cost=100,}) {
  const handleBuyClick = async () => {
  }
  return (
    <Card sx={{ minWidth: 100, width:'34vw', border: '3px solid #ff9700',
      borderRadius: '10%',backgroundColor: '#ffeddd' }}>
